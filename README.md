...
# After cloning and pulling, the way I have used the program has been to remove #'s from the portion of the main program I want to use, save, make, and repeat as necessary. 
